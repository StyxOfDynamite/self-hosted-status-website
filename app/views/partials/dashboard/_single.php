<div class="row">
	<div class="col-sm-12">
		...
		<div class="well">
			<div class="row">
				<div class="col-sm-12">
					<form action="/dashboard/incidents/<?= $this->e($page['key']); ?>" method="POST">
			...
			<?php foreach ($incidents as $incident) : ?>
				<div class="row">
					...
					<div class="col-sm-10">
						...
						<p><small class="light_font_color"><?= $this->e($incident['time']); ?></small></p>
					</div>
				</div>
			<?php endforeach; ?>
		</div>
...
<script type="text/javascript">
	var page<?= $this->e($page['key']); ?> = function() {
    	bootbox.dialog({
	        title: "Edit Page - <?= $this->e($page['name']); ?>",
...
?>
		var incident<?= $this->e($incident['key']); ?> = function() {
	    	bootbox.dialog({
		        backdrop: true,
		        title: "Edit Incident - <?= $this->e($page['name']); ?>",
		        message: '<form id="edit<?= $this->e($incident['key']); ?>" \
							...
							<div class="form-group"> \
					    		<label>Description</label> \
					   			<textarea class="form-control input-lg <?= $this->e($incident['key']); ?>" name="incident[description]" placeholder="Incident Description" style="max-width:100%;max-height:200px;"><?= $this->e($incident['description']); ?></textarea> \
					    	</div> \
						</form>',
		        buttons: {
		        	delete: {
