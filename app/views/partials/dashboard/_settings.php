...
<div class="row">
	<div class="col-sm-12">
		<h3 class="page-header">Styles & Template Settings</h3>
		<form action="/dashboard/settings" class="well" method="POST">
		<div class="row">
			<div class="col-sm-6">
		...
		<div class="row">
		    ...
		    <div class="col-sm-6">
		    	<div class="form-group">
		    		...
		    		<div class="input-group light_font_color">
